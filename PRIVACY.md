...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under New Zealand legal professional rules.
...
- New Zealand Law Society (NZLS) rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/newzealand-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (New Zealand)

### New Zealand Law Society Rules

New Zealand lawyers are bound by strict confidentiality rules under the Lawyers and Conveyancers Act 2006 and the Lawyers and Conveyancers Act (Lawyers: Conduct and Client Care) Rules 2008.

#### Legal Professional Privilege

- All client communications are privileged under the Evidence Act 2006
...
### Privacy Act 2020 and Client Data Processing

Under the **Privacy Act 2020** and the Information Privacy Principles (IPPs):

- You are responsible for ensuring personal information is handled lawfully
- Information must only be used for the purpose for which it was collected
- Cross-border disclosure of personal information requires adequate safeguards
- The **Office of the Privacy Commissioner** oversees compliance
...
```
Example: "What does the Resource Management Act say about environmental impact assessments?"
```
...
```
Example: "What are the penalties for insider trading under the Financial Markets Conduct Act?"
```

- Query pattern may reveal you are working on a financial markets matter
...
3. Client matters: Use commercial legal databases (LexisNexis NZ, Westlaw NZ, Brookers)

### For Large Firms / Corporate Legal

1. Negotiate privacy agreements with AI service providers
...
2. Follow New Zealand government information security requirements (NZISM)
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/newzealand-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **NZLS Guidance**: Consult New Zealand Law Society ethics guidance
