...
## [1.0.0] - 2026-XX-XX
### Added
- Initial release of New Zealand Law MCP
- `search_legislation` tool for full-text search across all New Zealand statutes
- `get_provision` tool for retrieving specific articles/sections
- `get_provision_eu_basis` tool for EU/international cross-references
...
[Unreleased]: https://github.com/Ansvar-Systems/newzealand-law-mcp/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/Ansvar-Systems/newzealand-law-mcp/releases/tag/v1.0.0
