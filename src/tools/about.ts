...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'New Zealand Law MCP',
    version: context.version,
    jurisdiction: 'NZ',
    description: 'New Zealand Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'New Zealand Legislation',
        url: 'https://www.legislation.govt.nz',
        authority: 'Parliamentary Counsel Office',
      },
    ],
    freshness: {
