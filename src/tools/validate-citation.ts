/**
 * validate_citation — Validate a New Zealand legal citation against the database.
 */
...
/**
 * Parse a New Zealand legal citation.
 * Supports:
 * - "Section 22 Privacy Act 2020" / "s 22 Privacy Act 2020"
 * - "Privacy Act 2020, s 22"
 * - "s22 Privacy Act 2020" (no space after s)
 * - Act name only (e.g., "Privacy Act 2020")
 */
    ...
    if (!provision) {
      return {
        results: {
          ...
          warnings: [...warnings, `Section "${parsed.sectionRef}" not found in ${doc.title}`],
        },
        _metadata: generateResponseMetadata(db),
      };
    }
