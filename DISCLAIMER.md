...
- **No Attorney-Client Relationship**: Use of this Tool does not create a solicitor-client or barrister-client relationship
...
If you are a lawyer, barrister, solicitor, legal executive, or other legal professional:
...
- **Professional Rules**: New Zealand Law Society (NZLS) members must comply with the Lawyers and Conveyancers Act 2006 and applicable conduct rules when using AI tools
...
1. Checking the official source (New Zealand Legislation (legislation.govt.nz), Parliamentary Counsel Office)
2. Verifying the provision is currently in force and has not been amended
3. Reading the full context of cited provisions
4. Consulting case law and Hansard for interpretation
...
This Tool aggregates data from official New Zealand legal databases. However:
...
| **NZLII / treaty databases** | Supplementary for case law | Case law and international obligations metadata |
...
- LexisNexis NZ, Thomson Reuters Westlaw NZ, Brookers
...
- New Zealand law changes continuously through new statutes, amendments, and court decisions
...
5. **Full legislative history** -- Limited coverage of select committee reports and explanatory notes
6. **Regulations and secondary legislation** -- Statutory instruments and regulations may have gaps
...
- **Context Missing**: Without commentary and legislative history, interpretation may be incorrect
- **Treaty Obligations**: Cannot fully assess international treaty obligations or compliance
...
2. **Official Verification**: Cross-check ALL results with official sources (legislation.govt.nz)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/newzealand-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/newzealand-law-mcp/issues
